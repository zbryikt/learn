...
;pug_debug_line = 3;pug_debug_filename = "frontend\u002Fweb\u002Fsrc\u002Fpug\u002Fenglish\u002Findex.pug";
pug_mixins["css"]([
    {name: "@loadingio/loading.css", path: "entries/bounce.min.css"},
    {name: "@loadingio/loading.css", path: "entries/jingle.min.css"}
  ]);
;pug_debug_line = 7;pug_debug_filename = "frontend\u002Fweb\u002Fsrc\u002Fpug\u002Fenglish\u002Findex.pug";
pug_html = pug_html + "\u003Cstyle type=\"text\u002Fcss\"\u003E";
;pug_debug_line = 7;pug_debug_filename = "frontend\u002Fweb\u002Fsrc\u002Fpug\u002Fenglish\u002Findex.pug";
pug_html = pug_html + "html,body{width:100%;height:100%}.cell{position:relative;user-select:none}.cell.active:after{content:\"\\f05c\";animation:ld-bounce 1s infinite;font-family:ldi;display:block;width:1em;height:1em;position:absolute;bottom:-0.5em;left:50%;margin-left:-0.5em}\u003C\u002Fstyle\u003E\u003C\u002Fhead\u003E";
...
;pug_debug_line = 25;pug_debug_filename = "frontend\u002Fweb\u002Fsrc\u002Fpug\u002Fenglish\u002Findex.pug";
pug_html = pug_html + "\u003Cdiv class=\"w-100 h-100 d-flex align-items-center justify-content-center\"\u003E";
;pug_debug_line = 26;pug_debug_filename = "frontend\u002Fweb\u002Fsrc\u002Fpug\u002Fenglish\u002Findex.pug";
pug_html = pug_html + "\u003Cdiv\u003E";
;pug_debug_line = 27;pug_debug_filename = "frontend\u002Fweb\u002Fsrc\u002Fpug\u002Fenglish\u002Findex.pug";
pug_html = pug_html + "\u003Cdiv class=\"p-4 border rounded mb-4 text-center font-weight-bold text-lg\" ld=\"word\"\u003E\u003C\u002Fdiv\u003E";
;pug_debug_line = 28;pug_debug_filename = "frontend\u002Fweb\u002Fsrc\u002Fpug\u002Fenglish\u002Findex.pug";
pug_html = pug_html + "\u003Cdiv class=\"d-flex g-1 text-lg mb-1 justify-content-center\" ld-each=\"english\"\u003E";
;pug_debug_line = 29;pug_debug_filename = "frontend\u002Fweb\u002Fsrc\u002Fpug\u002Fenglish\u002Findex.pug";
pug_html = pug_html + "\u003Cdiv class=\"cell p-2 border rounded-sm ld\" ld-each=\"cell\" style=\"text-transform:uppercase;font-family:monospace;animation-iteration-count:1\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
...
;pug_debug_line = 32;pug_debug_filename = "frontend\u002Fweb\u002Fsrc\u002Fpug\u002Fenglish\u002Findex.pug";
pug_html = pug_html + "\u003Cscript type=\"module\"\u003E";
;pug_debug_line = 32;pug_debug_filename = "frontend\u002Fweb\u002Fsrc\u002Fpug\u002Fenglish\u002Findex.pug";
pug_html = pug_html + "ld$.fetch(\"\u002Fassets\u002Fdata\u002Fenglish.json\",{method:\"GET\"},{type:\"json\"}).then(function(a){var s,i,n,c;s={};i=function(){var e,r,t,n,o,i,d;r=[];for(t in n=a){o=n[t];r.push(o)}e=r;i=e[Math.floor(e.length*Math.random())];d=i.list[Math.floor(i.list.length*Math.random())];d.engobj={words:d.english.map(function(e,r){return{text:e,idx:r}})};d.engobj.words.map(function(e){return e.chars=e.text.split(\"\").map(function(e,r){var t;t=e.toLowerCase().charCodeAt(0)-97;return{char:e,code:t,idx:r}})});s.word=d;c.setCtx(s);return d[\"try\"]=undefined,d.ptr=0,d};n=function(e){var r,t,n,o;r=e.node,t=e.ctx;n=c.get(\"answer\");o=n.value;if(o===t.word.english){alert(\"ok\")}else{alert(\"no\")}i();return c.render()};c=new ldview({initRender:false,ctx:s,root:document.body,handler:{word:function(e){var r,t;r=e.node,t=e.ctx;return r.innerText=t.word.chinese},english:{list:function(e){var r;r=e.ctx;return r.word.engobj.words},view:{handler:{cell:{list:function(e){var r;r=e.ctx;return r.chars},view:{handler:{\"@\":function(e){var r,t,n,o,i,d;r=e.node,t=e.ctx,n=e.ctxs;o=n[1].word.ptr\u003Et.idx;i=n[1].word.ptr===t.idx;d=i&&n[1].word[\"try\"]!=null&&n[1].word[\"try\"]!==t.code;if(n[1].word.ptr\u003E=n[0].chars.length){r.style.animationDelay=t.idx\u002Fn[0].chars.length*.4+\"s\";r.style.animationDuration=\".4s\";r.classList.add(\"ld-bounce\")}else{r.style.animationDelay=\"0s\";r.style.animationDuration=\"1s\";r.classList.remove(\"ld-bounce\")}r.classList.toggle(\"active\",i);r.innerText=o?t.char:\"?\";if(d){r.classList.remove(\"ld-jingle\",false);return setTimeout(function(){return r.classList.add(\"ld-jingle\")},150)}}}}}}}}},action:{click:{reply:function(e){var r;r=e.ctx;return n({ctx:r})}},keyup:{answer:function(e){var r,t;r=e.evt,t=e.ctx;if(r.keyCode===13){return n({ctx:t})}}}}});document.addEventListener(\"keypress\",function(e){var r,t,n;r=e.keyCode;r=r\u003E=65&&r\u003C97?r-65:r\u003E=97?r-97:void 8;if(r\u003E25){return}t=s.word.engobj.words[0].chars;if(!t[s.word.ptr]){return}n=t[s.word.ptr].code;s.word[\"try\"]=r;if(n===r){s.word[\"try\"]=undefined;s.word.ptr++;if(s.word.ptr\u003Et.length-1){setTimeout(function(){i();return c.render()},750)}}return c.render()});i();return c.render()});\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
